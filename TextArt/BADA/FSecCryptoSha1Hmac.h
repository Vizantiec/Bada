...
//
/** 
 * @file		FSecCryptoSha1Hmac.h
 * @brief		This is the header file for the %Sha1Hmac class.
 * 
 * This header file contains the declarations of the %Sha1Hmac class.
 */
#ifndef _FSEC_CRYPTO_SHA1_HMAC_H
#define _FSEC_CRYPTO_SHA1_HMAC_H
...
/**
 *	@class		Sha1Hmac 
 *	@brief		This class implements the SHA-1 HMAC algorithm.
 *	@since		1.0
 *
 * The %Sha1Hmac class implements the SHA-1 HMAC algorithm.
 *
 ...
 *	@see	IHmac, Md5Hmac, Sha2Hmac
 */
class _EXPORT_SECURITY_ Sha1Hmac :
...
public:
	 ...
	 *  This method is not supported by this class. Please do not call this method.
	...
	/** 
	 *	Updates a multiple-part HMAC operation, processing another data part.
	 *
	 * 	@since 		1.0
	 *	@return		An error code
	 *  @param[in]	input					An instance of %ByteBuffer
...
private:
	IHmacPi			*m_pIHmacPi;
	friend class 		Sha1HmacEx;
	class Sha1HmacEx*	__pSha1HmacEx;
};
};}; };// Osp::Security::Crypto

#endif //_FSEC_CRYPTO_SHA1_HMAC_H
