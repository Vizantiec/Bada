...
/** 
 * @file		gl.h 
 * @brief		This is the header file for the OpenGL(R) ES 1.1
 *
 * This header file contains the declarations of the OpenGL(R) ES 1.1
 */
 ...
 * The issue mentioned above is resolved in API version 1.1, and it is recommended to use API version 1.2 or above. @n	 
*/
/**
 *
 * Defines an array of point sizes. 
 * You can find more details at the Khronos Group site: http://www.khronos.org/opengles/sdk/1.1/docs/man  
 *
 * @since	1.2
 *
 * @compatibility This method has compatibility issues with different bada API versions @b prior @b to @b 1.2 . @n
 * 		For more information, see @ref EGLglPointSizePointerOES "here". 
 *
*/
