...
/**
 * @enum	LanguageCode
 * Defines the ISO 639-2 language code.
 *
 * The LanguageCode represents the ISO 639-2 language codes.  
 *
 * @since		1.0
 */
enum LanguageCode
{	
	...
	LANGUAGE_NOB, /**< "Bokm?l, Norwegian; Norwegian Bokm?l" */
	LANGUAGE_NOG, /**< "Nogai" */
	...
	LANGUAGE_NYO, /**< "Nyoro" */
	LANGUAGE_NZI, /**< "Nzima" */
	LANGUAGE_OCI, /**< "Occitan (post 1500); Proven?al" */
	LANGUAGE_OJI, /**< "Ojibwa" */
	LANGUAGE_ORI, /**< "Oriya" */
	LANGUAGE_ORM, /**< "Oromo" */
	LANGUAGE_OSA, /**< "Osage" */
	...
	LANGUAGE_PRO, /**< "Proven?al, Old (to 1500)" */
...
/**
 * @enum	CountryCode
 * Defines the ISO 3166-1 alpha-2 country code.
 *
 ...
 * 
 *
 * @see	LanguageCode, CountryCode, LocaleManager
 *
 */
 ...
 *
 * Variant code for SIMPLIFIED.
 *
 * @since	1.0
 */
static const char VARIANT_CODE_SIMPLIFIED[] = "SIMPLIFIED";
 ...
 * security-related issues that might arise after using this method.
 *
 * Variant code for TRADITIONAL.
 *
 * @since	1.0
 */
static const char VARIANT_CODE_TRADITIONAL[] = "TRADITIONAL";

class _EXPORT_LOCALES_ Locale :
	public Osp::Base::Object
{
// Construct Operations
public:
	/** 
	 * Initializes an instance of %Locale with the values of the specified locale.
	 *
	 * @since				1.0
	 ...
	 * @param[in]		pVariantCodeString				A pointer to the variant code string
	 */
	Locale(LanguageCode languageCode, CountryCode countryCode, const Osp::Base::String* pVariantCodeString = null);

	/**
	 * Assigns the values of the member variables of the specified instance to the member variables of the current instance.
	 *
	 * @since				1.0
...
// Operations
	 ...
	 * @param[in]		otherLocale						An instance of Locale
	 */
 	virtual bool operator==(const Locale& otherLocale) const;


	/**
	 *	Converts the operand obj to an object of the %Locale type and then compares it with the current instance of %Locale. 
	 *
	 *  @since		1.0
	 *	@return		@c true if the value of the current instance is equal to the value of the specified object, @n
	 *				else @c false
	...
	/**
	 * Gets the country code (ISO 3166-1 alpha-2 code) of the current instance of Locale.
	 *
	 * @since					1.0
	 ...
	 */
	Osp::Base::String GetLanguageCodeString(void) const;


	/**
	 * Gets the country code (ISO 3166-1 alpha-2 code) string of the current instance of %Locale.
	 *
	 * @since					1.0
	 * @return				The country code
	 */
	Osp::Base::String GetCountryCodeString(void) const;
	 ...
	 *
	 * @since					1.0
	 * @return				The variant code string, @n
     *                       else an empty string if the variant is not specified 
	 */
	Osp::Base::String GetVariantCodeString(void) const;
	 ...
	 *						For example, if the language code is LANGUAGE_ENG, country code is COUNTRY_US, and variant string is empty,
	 *						the locale code string is "eng_US".
	 * @see						GetLanguageCodeString(), GetCountryCodeString(), GetVariantCodeString()
	 */
	Osp::Base::String GetLocaleCodeString(void) const;
	 ...
	 */
	result GetCountryName(Osp::Base::String& countryName) const;
	 ...
	 */
	result GetCountryName(const Locale& otherLocale, Osp::Base::String& countryName) const;
	 ...
	 */
	result GetLanguageName(Osp::Base::String& languageName) const;
	 ...
	 * @exception				E_UNSUPPORTED_OPERATION			The specified @c locale is not supported.
	 */
	result GetLanguageName(const Locale& otherLocale, Osp::Base::String& languageName) const;

	
	/**
	 * Sets the variant code with the specified variant code string.
	 *
	 * @since						1.0
	 * @param[in]				pVariantCode			A pointer to the variant code
	 */
	void SetVariantCodeString(const Osp::Base::String* pVariantCode = null);
	 ...
	 */
	static LanguageCode StringToLanguageCode(const Osp::Base::String& languageCodeString);
	 ...
	 */
	static CountryCode StringToCountryCode(const Osp::Base::String& countryCodeString);
	 ...
	 * @param[in]		languageCode					The language code
	 */
	static Osp::Base::String LanguageCodeToString(LanguageCode languageCode);
	 ...
	 * @param[in]		countryCode						The country code
	 */
	static Osp::Base::String CountryCodeToString(CountryCode countryCode);
	 ...
	 * @param[in]		languageCode					The language code
	 */
	static Osp::Base::String LanguageCodeToTwoLetterLanguageCodeString(LanguageCode languageCode);
	 ...
	 */
	static LanguageCode TwoLetterLanguageCodeStringToLanguageCode(const Osp::Base::String& languageCodeString);
	 ...
	 * @param[in]		countryCode						The country code
	 */
	static Osp::Base::String CountryCodeToThreeLetterCountryCodeString(CountryCode countryCode);

	/**
	 * Returns the country code equivalent to the specified 3-letter country code string.
	 *
	 * @since				1.0
	 * @param[in]		countryCodeString				 The country code string
	 */
	static CountryCode ThreeLetterCountryCodeStringToCountryCode(const Osp::Base::String& countryCodeString);


private:
	/**
	 * Returns the locale cache list.
	 *
	 * @return					A list of supported locales
	 * @exception				E_SUCCESS				The method is successful.
	 * @remarks					The specific error code can be accessed using the GetLasResult() method.
	 */
	static Osp::Base::Collection::ArrayList* GetLocaleCache();

	/**
	 * Replaces this instance with the specified locale.
	 *
	 * @param[in]				other					The source locale
	 */
	void SetLocale(const Locale& other);

	static Osp::Base::String ConvertLanguageCodeString(Osp::Base::String sourceLanguageCodeString);
	static Osp::Base::String ConvertCountryCodeString(Osp::Base::String sourceCountryCodeString);

// Attributes
	LanguageCode		__languageCode;
	CountryCode			__countryCode;
	
	Osp::Base::String	__languageCodeString;
	Osp::Base::String	__countryCodeString;
	Osp::Base::String	__variantCodeString;
	Osp::Base::String	__localeCodeString;


private:
	friend class LocaleEx;
	class LocaleEx* __pLocaleEx;
}; // Locale 
