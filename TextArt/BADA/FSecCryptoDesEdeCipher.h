 ...
 */
#ifndef _FSEC_CRYPTO_DES_EDE_CIPHER_H
#define _FSEC_CRYPTO_DES_EDE_CIPHER_H
 ...
 *	
 *	@see	ISymmetricCipher, DesCipher, AesCipher
 */
class _EXPORT_SECURITY_ DesEdeCipher :
...
public:
	 ...
	 *										The valid values for DesEdeCipher are CIPHER_ENCRYPT and CIPHER_DECRYPT.
...
private:
	...
	friend class 		DesEdeCipherEx;
	class DesEdeCipherEx*	__pDesEdeCipherEx;
};
};}; };// Osp::Security::Crypto

#endif //_FSEC_CRYPTO_DES_EDE_CIPHER_H
