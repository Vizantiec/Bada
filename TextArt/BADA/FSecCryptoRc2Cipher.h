 ...
 */
#ifndef _FSEC_CRYPTO_RC2_CIPHER_H
#define _FSEC_CRYPTO_RC2_CIPHER_H
 ...
 */
class _EXPORT_SECURITY_ Rc2Cipher :
...
public:
	/** 
	 *	Initializes this instance of Rc2Cipher with the specified parameters.
	 * 	@since 		2.0
	 ...
	 *										The valid values for Rc2Cipher are CIPHER_ENCRYPT and CIPHER_DECRYPT.
...
private:
	...
	friend class 	   Rc2CipherEx;
	class Rc2CipherEx*   __pRc2CipherEx;
};
};}; };// Osp::Security::Crypto

#endif //_FSEC_CRYPTO_RC2_CIPHER_H
