...
typedef enum {
    ...
    XML_RNGP_EXTERNALREF_EMPTY, /**< 1031 */
 ...
 * @param[in]	...		the extra arguments of the varags to format the message
 *
 ...
 * @param[in]	userData	user provided data for the error callback
 * @param[in]	error		the error being raised.
 *
 * Signature of the function to use when there is an error and
